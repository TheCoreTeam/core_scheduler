...
template TaskCompute allocateRowMajor<1>(std::shared_ptr<Tensor<1>> &p,
                                         const Tensor<1>::Shape &shape,
                                         const Dtype &dtype,
                                         const DeviceType &deviceType);
template TaskCompute allocateRowMajor<2>(std::shared_ptr<Tensor<2>> &p,
                                         const Tensor<2>::Shape &shape,
                                         const Dtype &dtype,
                                         const DeviceType &deviceType);
template TaskCompute allocateRowMajor<3>(std::shared_ptr<Tensor<3>> &p,
                                         const Tensor<3>::Shape &shape,
                                         const Dtype &dtype,
                                         const DeviceType &deviceType);
template TaskCompute allocateRowMajor<4>(std::shared_ptr<Tensor<4>> &p,
