...
if __name__=="__main__":
    ...
    output1 = torch.nn.functional.gelu(input1)   # baseline
    input2 = input.clone()
    output2, save_for_backward = gelu.gelu_forward(input2)   # ours
    ...
    grad_input2 = gelu.gelu_backward(grad_output, save_for_backward)    # ours
