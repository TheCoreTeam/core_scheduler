...
def dropout_add_layernorm_init(
    ...
    init_info = (normalized_shape, eps, dropout_p)
...
def dropout_add_layernorm_forward(
    ...
    normalized_shape, eps, dropout_p = init_info
    x_shape_og = x.shape
...
def dropout_add_layernorm_backward(grad_output: torch.Tensor, save_for_backward: tuple):
