...
struct CS_API AmpEmbedding {
  struct State final : module::AmpState, Embedding::State {
    using Forward = Embedding::State::Forward;
    using Backward = Embedding::State::Backward;
    using Args = Embedding::State::Args;
  ...
  using Options = Embedding::Options;
